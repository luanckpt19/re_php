...
if (is_array($_POST) && !empty($_POST)) {
    ...
    $sqlInsert = "INSERT INTO `students` (`student_id`, `student_name`, `student_score`, `student_gender`, 
                                           `student_location`, `student_birthday`, `created`, `updated`) 
                  VALUES (NULL, '$student_name', '$student_score', '$student_gender', '$student_location',
                                 '$student_birthday', '$created', '$updated');";
