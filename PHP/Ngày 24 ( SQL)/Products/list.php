        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                if (is_array($list) && !empty($list)) {
                    foreach($list as $keyProduct => $product) {
                        // $student
                        ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $product->product_quantily ?></td>
                            <td><?php echo $product->product_desc ?></td>
                            <td>
                                <a href="update.php?id=<?php echo $product->product_id ?>" class="btn btn-warning">Edit</a>
